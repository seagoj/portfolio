...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    <head>    
        ...
        <script src="src/codesample.js" type="text/javascript"></script>
    ...
    <body onload="prettyPrint()">
        ...
        <div id='resume'>
            <div class='section'>
                ...
                <ul class='bullet'>
                    <li class='entry'>Worked 6+ years as an IT professional managing projects based on client specifications both as the sole consultant/developer and as a member of a project team.</li>
                    <li class='entry'>Experience in team based development with code review and open source projects</li>
                    <li class='entry'>Proficient with PHP, MySQL, Javascript, JQuery, CSS, HTML, C++, Java, ASP, AJAX frameworks, XML, Unix and Linux shell and Windows batch commands</li>
            ...
            <div id="codesample1">
                ...
                <pre class='prettyprint'>
                    <code class='language-php'>
                        <?php print file_get_contents('lib/model/src/Model.php'); ?>
                    </code>
                </pre>
            </div>
            <div id="shade"></div>
